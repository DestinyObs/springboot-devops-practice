...
module "ec2" {
  ...
  subnet_ids         = module.vpc.private_subnet_ids  # Use private subnets for production
  enable_eip         = false  # No EIP needed with ALB
...
# ALB Module (Always enabled for production)
module "alb" {
  source = "../../modules/alb"
